...
public class MediumAIPlayer extends AutoPlayer implements Serializable {
    ...
    public boolean canUnMarked(Game.Grid grid, Square sq) {return !canMarked(grid, sq);}
